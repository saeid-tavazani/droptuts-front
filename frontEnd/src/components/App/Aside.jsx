...
export default function Aside() {
  return (
    <aside
      ...
      className="hs-overlay hs-overlay-open:translate-x-0 translate-x-full transition-all duration-300 transform hidden z-[60] w-64 bg-white border-x border-gray-200  py-10 overflow-y-auto scrollbar-y h-full min-w-[256px] lg:block lg:-translate-x-0  "
    >
      <div className="px-6">
        <Link
      ...
      >
        <ul className="space-y-1.5">
          ...
          <li className="hs-accordion" id="users-accordion">
            <Link
              className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100    "
              href="javascript:;"
            >
              <svg
                className="w-3.5 h-3.5"
                ...
                <li className="hs-accordion" id="users-accordion-sub-1">
                  ...
                  >
                    <ul className="pt-2 pl-2">
                      <li>
                        <Link
                          className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100   "
                          href="javascript:;"
                        >
                          Link 1
                        </Link>
