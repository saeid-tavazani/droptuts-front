  ...
  return (
    <div className="h-fit">
      <Menu as="div" className="relative">
        ...
        >
          <Menu.Items className="absolute left-0 z-10 mt-2 w-48 origin-top-left transition-all rounded-md bg-box py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            {list.map((item, index) => (
              <Menu.Item key={index}>
                <Link
                  to={item.href}
