...
export default function AsidePanel({ status, user }) {
  return (
    <motion.aside
      ...
      className="animate-sidebar-navigation overflow-hidden duration-300 transition-width h-full bg-box shadow-sm border-gray-400 border-l hidden lg:flex lg:relative"
    >
